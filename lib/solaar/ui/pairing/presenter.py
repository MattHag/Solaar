...
class PairingViewProtocol(Protocol):
    def init_ui(self, presenter, ready_for_pairing: bool, page_title: str, page_text: str) -> None:
        ...

    def show_passcode(self, device_passkey):
        ...

    def pairing_failed(self, error, error1):
        ...

    def pairing_succeeded(self, receiver, new_device):
        ...
    ...
    def create_page(self, type, intro_text, param, page_text):
        ...
